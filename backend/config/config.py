...
class AgentConfig(BaseModel):
    ...
    # generate code
    code_generate_max_tokens: int = Field(default=2048, description="The max tokens of the code generate model")
    code_generate_summarization_trigger_messages: int = Field(default=10, description="The messages count when code generate summarization is triggered")
    code_generate_summarization_trigger_tokens: int = Field(default=1024, description="The tokens count when code generate summarization is triggered")
