...
from backend.sub_agent.code_generate.agents.docs_agents.data_source_agent.prompt import apply_prompt_template
from backend.sub_agent.code_generate.agents.generate import Generate
from backend.sub_agent.code_generate.middleware.doc_check_middleware import DocCheckMiddleware
...
AGENT_NAME = "data_source_doc_generator"

class DataSourceDocGenerate(Generate):
    def __init__(
            self,
