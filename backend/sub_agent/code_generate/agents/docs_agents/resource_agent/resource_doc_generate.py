...
from backend.sub_agent.code_generate.agents.docs_agents.resource_agent.prompt import apply_prompt_template
...
AGENT_NAME = "resource_doc_generator"

class ResourceDocGenerate(Generate):
    def __init__(
            self,
